...
- навбары: их наверное нужно привязать к верху и поправить централизацию, но это мелочи. что я имею сказать: ЦЫГАНСКИЕ ФОКУСЫ БЛИН. я понятия не имею почему, но ссылки просто-напросто не работают вне parent (а по логике им место ниже сообщений). поставь их адекватно как-нибудь.
